...
# 2019年7月28日21:20:36
# 数据集应该进行一定的修改，之前的好像就是取那一点跟我们想要的不太一样
...
x, y = loaddata(xlpath, length = 100000, start=15000)
# 后1000 留下测试
testlen = 10000
testDatastep = 1000
dat = trainDataGen(x, y, testDatastep)
...
for epoch in range(num_epochs):
    ...
    for inputs, outs in dat:
        inputs = ToVariable(inputs).cuda()
...
torch.save(model.state_dict(),
           'net_lstm_parameters'+str(np.random.randint(1,1000))+'.pkl')
